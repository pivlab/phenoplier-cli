...
FINAL_IMPUTED_GWAS_DIR="${PHENOPLIER_RESULTS_GLS_NULL_SIMS_UKB_50PCS}/final_imputed_gwas"
SPREDIXCAN_DIR="${PHENOPLIER_RESULTS_GLS_NULL_SIMS_UKB_50PCS}/twas/spredixcan"
