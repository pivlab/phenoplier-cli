...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", choices=["full", "testing", "demo"], default="full", help="Specifies which kind of data should be downloaded.")
    parser.add_argument("--actions", nargs="+", help="Specifies a list of actions to be executed.")
    args = parser.parse_args()

    setup_data(mode=args.mode, actions=args.actions)